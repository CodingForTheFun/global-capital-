...
const aliases = {
  ...
  Clearances:['clearances','totalClearance'], AttemptedDribbles:['attemptedDribbles','totalContest'],
...
const soccer = {player_shots:['Shots'],player_shots_on_target:['ShotsOnTarget'],player_goals:['SoccerGoals'],
  ...
  player_goalie_saves:['Saves'],player_clearances:['Clearances'],player_attempted_dribbles:['AttemptedDribbles']};
const soccerLabels = {shots:['Shots'],'shots on target':['ShotsOnTarget'],sot:['ShotsOnTarget'],goals:['SoccerGoals'],
  ...
  'goalie saves':['Saves'],saves:['Saves'],clearances:['Clearances'],'attempted dribbles':['AttemptedDribbles']};
