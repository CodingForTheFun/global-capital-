...
const PAGES = new Set(['/', '/board', '/scores', '/news', '/research', '/account', '/api/news', '/api/news/image', '/app.webmanifest', '/app-worker.js', '/app-icons/180.png', '/app-icons/192.png', '/app-icons/512.png']);
