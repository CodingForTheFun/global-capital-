...
export function PropExplorer({group,games,loading,unavailableReason,state,onState,favourite,onFavourite,hideBookFilter=false}:{group:PropGroup;games:GameLogRow[];loading?:boolean;unavailableReason?:string|null;state:ExplorerState;onState(next:ExplorerState):void;favourite:boolean;onFavourite():void;hideBookFilter?:boolean}){
