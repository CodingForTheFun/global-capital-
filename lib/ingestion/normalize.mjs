...
const v2Off=o=>!o||o.active===false||o.is_active===false||o.is_live===true||o.live===true||o.live_event===true||/^(suspended|closed|settled|removed|in_progress|unavailable)$/i.test(o.status||'');
...
export function normalizeUnderdog(payload){
 ...
 for(const row of payload.over_under_lines){
  ...
  if(!p||!appearance||!g||inactive(row)||inactive(p))continue;
