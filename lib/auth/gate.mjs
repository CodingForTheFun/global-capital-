...
const GATED_API_PREFIXES = [
  ...
  '/api/apex/propline',
  '/api/apex/research',
  // Explicit entries even where /api/apex/research already matches by prefix:
  // every data route is listed on its own so a rename can never ungate it.
  '/api/apex/research-moneyline',
  '/api/apex/research-tennis',
  '/api/apex/research-movement',
  // Teammate participation for with/without splits.
  '/api/apex/research-teammates',
  // Player search and profile identity.
  '/api/apex/research-players',
  '/api/apex/research-player',
  // Realtime line movement, steam and suspensions from the paid feed.
  '/api/apex/live-moves',
