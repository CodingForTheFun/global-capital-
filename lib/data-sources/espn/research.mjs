...
const STAT_OUTPUT = {
  Points:'points',Rebounds:'rebounds',OffensiveRebounds:'offensiveRebounds',DefensiveRebounds:'defensiveRebounds',Assists:'assists',Steals:'steals',BlockedShots:'blocks',Turnovers:'turnovers',ThreePointersMade:'threes',
