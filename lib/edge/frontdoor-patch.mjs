...
export function patchEdgeFrontdoor(source) {
  ...
  output = output.replace(injection, 'const injection = `<link rel="stylesheet" href="/assets/edge-theme.css"><link rel="stylesheet" href="/assets/edge-workspace-nav.css"><script>${APEX_SHELL}</script><script src="/assets/edge-workspace-nav.js" defer></script><script src="/assets/autoscout-tacos.js" defer></script>`;');
  return output;
}
