 ...
 * PickFinder detail page does not expose (usage, minutes, injuries, pace,
 * line movement, book projections) stays absent rather than being guessed.
 */
export function fromPickFinder(pick, { scannedAt = null } = {}) {
  ...
  return {
    ...
    enrichedBy: null,
    // Provenance: which provider matched this player, how confidently, and when.
    enrichment: null,
