...
export function toResearchGroup(player:WorkspacePlayer,market:WorkspaceMarket,offer:WorkspaceOffer):PropGroup{
 ...
 const quotes=market.offers.filter(o=>o.line===offer.line&&o.side).map(o=>({id:o.outcomeId||o.key,eventId:player.eventId,playerName:player.name,providerPlayerId:player.playerId||undefined,market:market.label,marketId:market.marketKey,line:o.line??undefined,side:o.side||undefined,price:o.price??undefined,sportsbook:o.bookName,sportsbookKey:o.book,gameStartTime:player.startsAt||undefined,providerUpdatedAt:o.updatedAt||undefined}));
