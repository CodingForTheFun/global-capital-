...
const TENNIS_MARKETS = Object.freeze({
  'aces': ['Aces'], 'ace': ['Aces'],
  'double faults': ['DoubleFaults'], 'double fault': ['DoubleFaults'],
  'games won': ['GamesWon'], 'total games won': ['GamesWon'],
  'sets won': ['SetsWon'], 'total sets won': ['SetsWon'],
  'break points won': ['BreakPointsWon'], 'break points converted': ['BreakPointsWon'],
  'points won': ['PointsWon'], 'total points won': ['PointsWon'],
...
export const PROVIDER_MARKET_KEYS = Object.freeze({
  ...
  player_aces: 'aces', player_ace: 'aces', player_double_faults: 'double faults',
  player_games_won: 'games won', player_sets_won: 'sets won', player_break_points_won: 'break points won',
