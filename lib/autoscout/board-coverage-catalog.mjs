// SportsGameOdds sport-level coverage. These are board/query aliases for the
// provider's documented sportID values. NON_SPORTS is intentionally excluded:
 // this product is a sports prop research board, not a politics/TV market board.
export const SPORTSGAMEODDS_BOARD_SPORTS = Object.freeze([
  'AUSSIE_RULES','BADMINTON','BANDY','BASEBALL','BASKETBALL','BEACH_VOLLEYBALL',
  'BOXING','CRICKET','DARTS','ESPORTS','FLOORBALL','FOOTBALL','FUTSAL','GOLF',
  'HANDBALL','HOCKEY','HORSE_RACING','LACROSSE','MMA','MOTORSPORTS','RUGBY',
  'SNOOKER','SOCCER','TABLE_TENNIS','TENNIS','VOLLEYBALL','WATER_POLO',
]);
