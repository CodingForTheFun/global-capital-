...
const assets = new Map([
  ...
  ['/assets/autoscout-reference-ui.css', { type: 'text/css; charset=utf-8', body: readFileSync(new URL('../../public/autoscout-reference-ui.css', import.meta.url)) }],
  ['/assets/autoscout-reference-ui-fixes.css', { type: 'text/css; charset=utf-8', body: readFileSync(new URL('../../public/autoscout-reference-ui-fixes.css', import.meta.url)) }],
  ['/sw.js', { type: 'text/javascript; charset=utf-8', body: readFileSync(new URL('../../public/sw.js', import.meta.url)), serviceWorker: true }],
]);
...
export function serveWorkspaceAsset(req, res) {
  ...
  res.writeHead(200, {
    ...
    'cache-control': asset.serviceWorker ? 'no-cache, no-store, must-revalidate' : 'no-cache',
