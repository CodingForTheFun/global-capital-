...
//
// Coverage, verified by probing the live API (401 = feed exists, 404 = it does
// not). This is product coverage, not a subscription tier: the "none" rows
// cannot be bought, so props in those leagues are always returned un-enriched.
//
//   PickFinder sport   projections   scores/stats
//   NBA                yes           yes
//   NFL                yes (week)    yes (week)
//   MLB                yes           yes
//   NHL                yes           yes
//   CS2  (csgo)        yes           yes      <- not yet mapped here
//   LOL                yes           yes      <- not yet mapped here
//   WNBA               none          scores only
//   NCAAB (cbb)        none          scores + stats
//   NCAAF (cfb)        none          scores + stats
//   Tennis             none          none
//   VAL / DOTA2 / COD  none          none
//
...
/** Leagues Scout Pro scans for which no projections feed exists to buy. */
export const UNSUPPORTED_LEAGUES = Object.freeze([
  'WNBA', 'NCAAF', 'CFB', 'NCAAB', 'CBB', 'TENNIS', 'VAL', 'DOTA2', 'COD',
]);

/** Projections exist for these and could be mapped next; markets differ. */
