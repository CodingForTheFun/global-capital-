...
const CLIENT_MODULES = new Map([
  ...
  'lib/betting/kelly.mjs', 'lib/markets/line-lag.mjs', 'lib/props/dfs-edge.mjs', 'lib/betting/slip-correlation.mjs',
...
async function maybeServeResearch(req, res) {
  ...
  try {
    const result = await researchPlayerProp({
      ...
      sportsGameOddsPlayerId: safeParam(url, 'sportsGameOddsPlayerId', 96) || null,
      sportsGameOddsEventId: safeParam(url, 'sportsGameOddsEventId', 160) || null,
      sportsGameOddsLeagueId: safeParam(url, 'sportsGameOddsLeagueId', 96) || null,
      sportsGameOddsStatId: safeParam(url, 'sportsGameOddsStatId', 96) || null,
