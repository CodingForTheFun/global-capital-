...
const PAGES = Object.freeze({
  '/pricing': { title: 'Pricing', description: 'What Oblige Props costs, and what each plan includes.', body: pricingBody },
  '/checkout': { title: 'Checkout', description: 'Finish upgrading your Oblige Props account.', body: checkoutBody },
});
