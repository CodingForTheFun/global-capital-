  ...
  try {
    if (publicWorkerConfigured()) {
      try {
        ...
        console.log(`[AutoScout public snapshots] ${reason} claimed=${Boolean(snapshot.claimed)} written=${written}`);
      } catch (error) {
    ...
    // This cache-only loop is forbidden from spending paid-provider credits.
