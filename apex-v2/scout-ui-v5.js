...
function shell(){
 ...
 <header class="asTop"><div class="asBar"><a class="asIdentity" href="/apex" aria-label="Oblige Props Research"><div class="asLogo">A</div><span class="asBrand">Props</span></a><div class="asSports" id="asSports" aria-label="Sports"></div><span class="asGrow"></span><span class="asStatus" id="asStatus">Current sportsbook lines</span><button class="asBtn" id="asRefresh">Refresh</button></div></header>
...
function authUnavailableNotice(){
 ...
 return '<div class="asAvailability">Sign-in is not switched on yet. Google sign-in and verification email both need to be configured before accounts can be created. Everything else on Oblige Props works without an account.</div>';
}
...
function authPanel(view,prefill){
 ...
 var form=canPassword
  ...
  :'';
 utility(forgot?'Reset your password':signup?'Create your account':'Sign in to Oblige Props',
  authUnavailableNotice()+googleBlock()+tabs+form
  +'<p class="asNotice" id="asAuthError" role="alert"></p>'
  +'<hr><p class="asNotice">Oblige Props is a research tool. It reports what the connected feeds actually returned — it does not take bets or handle money.</p>'
  +accuracyBlock()
