...
// Soccer and tennis remain opt-in at the shared model layer. The zero-cost
// persistence scheduler can add them without widening any paid-provider loop.
export const SUPPORTED_SPORTS = Object.freeze([...AUTOMATIC_SPORTS,'MLS','EPL','UCL','TENNIS']);
