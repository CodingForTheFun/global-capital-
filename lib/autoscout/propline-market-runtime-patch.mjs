 ...
 var chips=choices.map(function(item){
  ...
  return open
   ...
   +'<div class="asOddsValues">'
    +(over?'<span class="o"><strong>O '+esc(dec(over.line))+'</strong><i>'+esc(money(over.price))+'</i></span>':'')
    +(under?'<span class="u"><strong>U '+esc(dec(under.line))+'</strong><i>'+esc(money(under.price))+'</i></span>':'')
   +'</div>'
...
@media(max-width:540px){#as5 .asOddsStrip.asPropBookStrip{margin-left:8px!important;margin-right:8px!important;padding:7px!important;gap:5px!important}#as5 .asOddsRail{gap:7px!important}#as5 .asOddsChip{flex:0 0 calc(50% - 4px)!important;min-width:0!important;min-height:76px!important;padding:7px 8px!important;gap:4px!important}#as5 .asOddsValues>span{padding:4px 5px!important}#as5 .asOddsHead>strong{max-width:58%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#as5 .asPropBookControl{grid-template-columns:1fr!important;gap:4px!important}#as5 .asPropBookControl .asPropBookValues{justify-content:space-between!important}}
`;
