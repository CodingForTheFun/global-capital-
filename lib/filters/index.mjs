...
export function clearFilter(filters, id, value = null) {
  ...
  const listFields = ['sports', 'markets', 'players', 'teams', 'opponents', 'games', 'qualityTiers', 'matchup', 'injuryStatuses', 'liveStatuses'];
...
const LIST_KEYS = ['sports', 'markets', 'players', 'teams', 'opponents', 'games', 'qualityTiers', 'matchup', 'injuryStatuses', 'liveStatuses'];
