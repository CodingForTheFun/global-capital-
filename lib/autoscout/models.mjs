...
import { ADDITIONAL_PUBLIC_SPORTS, SCOPED_PUBLIC_SPORTS } from './board-coverage-catalog.mjs';
...
export const BOARD_SPORTS = Object.freeze([...SUPPORTED_SPORTS, ...PUBLIC_FEED_SPORTS]);
