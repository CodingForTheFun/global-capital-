...
`;
 ...
 if(!boardCoverageResearchSports.includes(coverageSport))return {ok:true,available:false,lineOnly:true,retryable:false,code:'HISTORICAL_SOURCE_UNVERIFIED',message:'Live line available. Verified research is unavailable for this sport or market scope.'};`, 'line-only research policy');
