...
// Underdog v2 commonly sends live_event:false on ordinary pregame lines. The
// legacy predicate above intentionally treats any live_event field as suspect,
// so v2 needs a boolean-aware check instead of discarding the whole feed.
const v2Off=o=>!o||o.active===false||o.is_active===false||o.is_live===true||o.live===true||o.live_event===true||(o.live_event&&typeof o.live_event==='object')||/^(suspended|closed|settled|removed|in_progress|unavailable)$/i.test(o.status||'');
...
function marketFallbackKey(value){
...
export function record(input){
 ...
 const fallbackMarketKey=marketFallbackKey(market),period=inferPeriod(sport,market,input.period);
