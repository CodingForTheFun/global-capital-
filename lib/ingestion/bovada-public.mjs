...
const SPORT_PATHS = Object.freeze({
  ...
  NCAAF: 'football/college-football', NCAAB: 'basketball/college-basketball', SOCCER: 'soccer',
});
...
function marketLabel(value) {
  ...
  const rules = [
    ...
    [/shots?\s+on\s+target/i, 'Shots on Target'], [/shots?\s+on\s+goal/i, 'Shots on Goal'], [/passes?\s+attempted/i, 'Passes Attempted'], [/passes?\s+completed/i, 'Passes Completed'], [/attempted\s+dribbles?/i, 'Attempted Dribbles'], [/clearances?/i, 'Clearances'], [/tackles?/i, 'Tackles'], [/\bshots?\b/i, 'Shots'], [/blocked\s+shots?/i, 'Blocked Shots'], [/saves?/i, 'Saves'], [/goals?/i, 'Goals'],
  ];
