...
export const PROP_PROVIDER_MODES = Object.freeze(['auto', 'sportradar', 'propline', 'sportsgameodds', 'mesh']);
...
export function providerRouting(env = process.env) {
  ...
  if (mode === 'mesh') {
    return {
      ...
      enabled: ['sportsgameodds', 'propline', 'sportradar'],
      fallback: ['propline', 'sportradar'],
    };
  }
