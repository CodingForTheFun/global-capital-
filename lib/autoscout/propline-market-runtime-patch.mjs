...
@media(max-width:540px){#as5 .asOddsStrip.asPropBookStrip{margin-left:8px!important;margin-right:8px!important;padding:8px!important}#as5 .asOddsChip{flex-basis:148px!important;min-height:88px!important}#as5 .asOddsHead>strong{max-width:58%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#as5 .asPropBookControl{grid-template-columns:1fr!important}#as5 .asPropBookControl .asPropBookValues{justify-content:space-between!important}}
`;
