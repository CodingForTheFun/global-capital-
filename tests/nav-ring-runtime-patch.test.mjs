...
test('nav/ring runtime patch keeps research basis and installs compact glass navigation', () => {
  ...
  assert.match(output, /backdrop-filter:blur\(24px\) saturate\(145%\)/, 'glass treatment must be installed');
  assert.match(output, /height:44px!important/, 'mobile nav must stay compact');
