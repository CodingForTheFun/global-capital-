...
export const canonicalSport = value => {
  ...
  if(!raw)return '';
  if(raw==='ATP'||raw==='WTA'||raw==='TENNIS'||raw.startsWith('ATP_')||raw.startsWith('WTA_')||raw.includes('TENNIS'))return 'TENNIS';
...
const aliases = {
  ...
  Aces:['aces'], DoubleFaults:['doubleFaults','double_faults'], GamesWon:['gamesWon','games_won'], SetsWon:['setsWon','sets_won'],
  BreakPointsWon:['breakPointsWon','breakPointsConverted','break_points_won'], PointsWon:['pointsWon','totalPointsWon','points_won'],
