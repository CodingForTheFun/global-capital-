...
export function isComboMarket(market) {
  return /\bcombo\b/i.test(text(market));
}
...
export function researchSelectionPolicy({ sport, playerName, market, providerMarketKey, marketId } = {}) {
  if (isMultiPlayerSelection(playerName) || isComboMarket(market)) {
    return {
      eligible: false,
      code: 'COMBO_HISTORY_UNVERIFIED',
