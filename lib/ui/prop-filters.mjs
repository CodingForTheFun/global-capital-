...
export function propFiltersHtml(base,filters={},venue='all'){
 ...
 if(rows.some(r=>r.team))html+=field('team','Historical team',options('team'));
 ...
 return '<div class="asPropFilterGrid">'+html+'</div><button class="asBtn" id="asClearPropFilters">Reset prop filters</button><p class="asNotice">Filters apply to this player’s recorded game sample. Missing values are excluded when a filter requires them.</p>';
}
