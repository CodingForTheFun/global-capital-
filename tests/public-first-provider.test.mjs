...
const saved = new Map();
for (const key of ['DATA_DIR','AUTOSCOUT_SUPABASE_URL','AUTOSCOUT_SUPABASE_PUBLISHABLE_KEY','AUTOSCOUT_SUPABASE_INGEST_TOKEN','AUTOSCOUT_PUBLIC_FIRST','THE_ODDS_API_KEY','SPORTSDATAIO_API_KEY']) saved.set(key, process.env[key]);
