...
export async function fetchDraftKingsSportsbookPublic(sport, options = {}) {
  ...
  // DraftKings' current public web app uses SportsContent. Prefer that modern
  // schema, but keep every known-good legacy path as a fallback so this change
  // cannot erase existing last-known-good sportsbook rows.
  try {
