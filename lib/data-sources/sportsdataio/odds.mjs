 ...
 *
 * Important: Participant is intentionally ignored. SportsDataIO explicitly
 * describes it as sportsbook free text and recommends PlayerID for identity.
 */
  ...
  function visit(node, parent = {}) {
    ...
    if (outcomes) {
      for (const outcome of outcomes) {
        ...
        // Use canonical provider player-name fields only. Never Participant.
        const playerName = text(outcome.PlayerName) || context.playerName || null;
        if (!playerId || !side || line === null) continue;
