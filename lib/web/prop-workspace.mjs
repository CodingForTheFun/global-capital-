...
const TENNIS = {player_aces:'aces',player_double_faults:'dblfaults',player_games_won:'games_w',player_break_points_won:'breakpts_w',player_total_games:'total_games',tennis_total_games:'total_games',match_total_games:'total_games',player_sets_won:'sets_won'};
