...
const GRID_BASE = `https://sports.${STATE}.betmgm.com/cds-api/offer-grouping/grid-view/all`;
  ...
  try {
    ...
    try {
      ...
      const data = await browserJsonFetch(String(url), {
        origin: `https://sports.${STATE}.betmgm.com`,
        referer: `https://sports.${STATE}.betmgm.com/en/sports`,
        userAgent: UA,
        timeoutMs: 22_000,
        headers: { 'x-bwin-browser-url': `https://www.${STATE}.betmgm.com/en/sports`, 'x-from-product': 'host-app' },
      });
