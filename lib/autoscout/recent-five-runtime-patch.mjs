...
#as5 .asPpSpecialChip b{color:#f8fafc}.asPpSpecialChip em{font-style:normal;color:#aeb9c9;font-weight:900}
#as5 .asPpFace{display:inline-grid;width:20px;height:20px;place-items:center}.asPpFace svg{display:block;width:20px;height:20px}.asPpFace.goblin{color:#22c55e}.asPpFace.demon{color:#f43f5e}
...
export function patchRecentFiveUi(source) {
  ...
  patched = replaceOnce(
    patched,
    IMPORT_ANCHOR,
    `${IMPORT_ANCHOR}\nvar {prizePicksSpecialFaceHtml,removeExpiredPrizePicksSpecials}=await import('/assets/lib/ui/prizepicks-special-lines.mjs');`,
    'promotion import',
  );
