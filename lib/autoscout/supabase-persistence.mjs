...
// 100-row chunks made production-sized NFL/WNBA boards require dozens of
// sequential RPCs and routinely exhaust the scheduler's per-sport budget.
// 250 remains bounded well below the old all-in-one transaction while reducing
// round trips enough for a full sport write to complete inside its fair share.
const RPC_BOARD_BATCH_SIZE = 250;
