...
const SPORT_PATHS = Object.freeze({ MLB: 'baseball/mlb', NBA: 'basketball/nba', NFL: 'american_football/nfl', NHL: 'ice_hockey/nhl', SOCCER: 'soccer' });
...
function marketLabel(value) {
  ...
  const rules = [
    ...
    [/strikeouts?/i, 'Strikeouts'], [/hits?/i, 'Hits'], [/shots?\s+on\s+target/i, 'Shots on Target'], [/shots?\s+on\s+goal/i, 'Shots on Goal'], [/passes?\s+attempted/i, 'Passes Attempted'], [/passes?\s+completed/i, 'Passes Completed'], [/attempted\s+dribbles?/i, 'Attempted Dribbles'], [/clearances?/i, 'Clearances'], [/tackles?/i, 'Tackles'], [/\bshots?\b/i, 'Shots'], [/blocked\s+shots?/i, 'Blocked Shots'], [/saves?/i, 'Saves'], [/goals?/i, 'Goals'],
  ];
