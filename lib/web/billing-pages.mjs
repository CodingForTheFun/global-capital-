...
<p>Founding Pro pays for the live data feeds and the storage this runs on. Early members get the highest limits.</p>
</section>
<p class="sub">The core stays free. Upgrade when you want the higher limits and the alerts.</p>
<div class="tiers">
...
<p class="sub">Sportsbook data and storage are the two real costs. Memberships cover them.</p>
<div class="fundingGrid">
 <div class="fundingCard"><b>Faster live sportsbook data</b><span>Broader book coverage and faster updates, once a commercial feed is affordable.</span></div>
 <div class="fundingCard"><b>Permanent line history</b><span>Opening numbers, every move and closing lines, kept so the history is ours to search.</span></div>
 <div class="fundingCard"><b>Deeper verified research</b><span>More H2H and fantasy-score history, added only when the game logs behind it hold up.</span></div>
 <div class="fundingCard"><b>Infrastructure &amp; monitoring</b><span>Hosting, storage, and the monitoring that catches a broken feed before you do.</span></div>
</div>
...
<div class="callout">
<p><b>Every plan sees the same numbers.</b> Hit rates, line comparisons and fair value come from the same data whatever you pay. Founding Pro raises your limits. It does not buy you a better answer.</p>
