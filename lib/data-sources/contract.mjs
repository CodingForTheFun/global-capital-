...
// game start times, player images, live status and sportsbook context.
//
...
export const ENRICHABLE_FIELDS = Object.freeze([
  ...
  // Sportsbook market context. These never overwrite PickFinder's line/side.
  'bettingMarketId',
  'marketConsensusLine',
  'bestSportsbookLine',
  'bestSportsbookOddsAmerican',
  'sportsbookCount',
  'sportsbookOutcomes',
  'bettingUpdatedAt',
  'lineMovement',
