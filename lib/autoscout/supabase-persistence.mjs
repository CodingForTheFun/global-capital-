...
//
// Writing only what changed keeps the history and drops roughly three fifths
// of the volume. The cache is per-process and deliberately not persisted: a
// restart re-records one row per quote, which is a baseline worth having, not
// a flood.
