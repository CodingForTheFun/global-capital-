...
export function patchEdgeFrontdoor(source) {
  ...
  for (const anchor of [hook, server, landingImport, shellRead, injection]) {
  ...
  output = output.replace(injection, 'const injection = `<link rel="stylesheet" href="/assets/autoscout-home.css"><link rel="manifest" href="/manifest.webmanifest"><script>${APEX_SHELL}</script><script src="/assets/autoscout-home.js" defer></script><script src="/assets/autoscout-tacos.js" defer></script>`;');
  return output;
}
