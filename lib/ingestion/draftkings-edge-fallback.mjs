...
export async function fetchDraftKingsSportsbookPublic(sport, options = {}) {
  ...
  // DraftKings' current public web app uses SportsContent. Railway egress can
  // be blocked by Akamai even when the same public endpoint is healthy, so try
  // the authenticated Supabase edge relay before falling back to obsolete v5.
