...
//
// Rule: the dashboard NEVER receives an error string that Oblige Props did not
...
export const GENERIC_MESSAGE = 'Oblige Props could not complete that request. Please try again.';
...
export const PUBLIC_MESSAGES = Object.freeze({
  ...
  PICKFINDER_INTERACTIVE_AUTH: 'PickFinder needs a verification step completed on its own site. Finish that on PickFinder, then reconnect Oblige Props.',
  ...
  SCAN_OUTPUT_INVALID: 'The scan was blocked by Oblige Props data-quality protection. No unverified cards were published.',
 ...
 * Returns { message, code } where message is always Oblige Props-authored copy.
 */
