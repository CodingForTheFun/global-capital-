...
server.listen(port, () => {
  console.log(`AutoProp Scout Pro professional server running on http://localhost:${port}`);
  console.log('Mode: live');
  console.log('Scanner: PickFinder v2 + hardened auth + output quality gate');
  console.log('Dashboard access: owner + generated member codes');
